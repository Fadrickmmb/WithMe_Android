...
public class Admin_AddPostPage extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_add_post_page);
    ...
    private void setupNavigation() {
        homeIcon.setOnClickListener(view -> startActivity(new Intent(Admin_AddPostPage.this, Admin_HomePage.class)));
        searchIcon.setOnClickListener(view -> startActivity(new Intent(Admin_AddPostPage.this, Admin_SearchPage.class)));
        addPostIcon.setOnClickListener(view -> startActivity(new Intent(Admin_AddPostPage.this, Admin_AddPostPage.class)));
        smallAvatar.setOnClickListener(view -> startActivity(new Intent(Admin_AddPostPage.this, Admin_ProfilePage.class)));
    }
        ...
        fileReference.putFile(postImgUri).addOnSuccessListener(taskSnapshot -> {
            fileReference.getDownloadUrl().addOnSuccessListener(uri -> {
                ...
                reference.child(mAuth.getUid()).setValue(userData).addOnCompleteListener(task -> {
                    ...
                    Log.e("Mod_AddPostPage", "createPost: ", err);
                    Toast.makeText(this, "Failed to create post", Toast.LENGTH_SHORT).show();
                });
            });
        ...
        if (user != null) {
            reference.child(mAuth.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(Admin_AddPostPage.this, "Failed to load user data.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
