...
public class Admin_AddPostPage extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void setupNavigation() {
        homeIcon.setOnClickListener(view -> startActivity(new Intent(Admin_AddPostPage.this, Mod_HomePage.class)));
        searchIcon.setOnClickListener(view -> startActivity(new Intent(Admin_AddPostPage.this, Mod_SearchPage.class)));
        addPostIcon.setOnClickListener(view -> startActivity(new Intent(Admin_AddPostPage.this, Mod_AddPostPage.class)));
        smallAvatar.setOnClickListener(view -> startActivity(new Intent(Admin_AddPostPage.this, Mod_ProfilePage.class)));
    }
