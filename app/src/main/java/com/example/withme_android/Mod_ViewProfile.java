...
public class Mod_ViewProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mod_view_profile);
        ...
        if(visitedUserId != null) {
            ...
            suspendRef.child(visitedUserId).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(Mod_ViewProfile.this, "Error loading suspension status.", Toast.LENGTH_SHORT).show();
                }
            });

        } else {
            Toast.makeText(Mod_ViewProfile.this,"Error loading user profile.", Toast.LENGTH_SHORT).show();
        }
        ...
        homeIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Mod_ViewProfile.this, Mod_HomePage.class);
        ...
        searchIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Mod_ViewProfile.this, Mod_SearchPage.class);
        ...
        addPostIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Mod_ViewProfile.this, Mod_AddPostPage.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        smallAvatar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Mod_ViewProfile.this, Mod_ProfilePage.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void suspendUser(){
        AlertDialog.Builder builder = new AlertDialog.Builder(Mod_ViewProfile.this);
        ...
        yesSuspendUserBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                suspendRef.child(visitedUserId).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            suspendRef.child(visitedUserId).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(Mod_ViewProfile.this, "User unsuspended.", Toast.LENGTH_SHORT).show();
                                        suspendUserBtn.setEnabled(true);
                                        suspendUserBtn.setText("Suspend User");
                                    } else {
                                        Toast.makeText(Mod_ViewProfile.this, "Error unsuspending user.", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                        } else {
                            ...
                            suspendRef.child(visitedUserId).setValue(suspendUser).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(Mod_ViewProfile.this, "User suspended.", Toast.LENGTH_SHORT).show();
                                        suspendUserBtn.setEnabled(false);
                                        suspendUserBtn.setText("Unsuspend User");
                                    } else {
                                        Toast.makeText(Mod_ViewProfile.this, "Error suspending user.", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                        }
                    ...
                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(Mod_ViewProfile.this, "Database error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        visUserRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(visitedUser !=  null) {
                    ...
                    Toast.makeText(Mod_ViewProfile.this, "User data not found.", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Mod_ViewProfile.this, "Failed to load user data.", Toast.LENGTH_SHORT).show();
            }
        });
