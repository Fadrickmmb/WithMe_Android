...
public class Mod_SearchPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mod_search_page);
        ...
        searchInput = findViewById(R.id.mod_searchPage_input);
        searchButton = findViewById(R.id.mod_searchPage_searchButton);
        result01 = findViewById(R.id.mod_searchPage_result01);
        result02 = findViewById(R.id.mod_searchPage_result02);
        toHome = findViewById(R.id.mod_searchPage_buttonToHome);
                        ...
                        for (DataSnapshot userSnapshot : snapshot.getChildren()) {
                            ...
                            if (name != null && name.toLowerCase().startsWith(searchPrefix)) {
                                ...
                                result01.setOnClickListener(v -> {
                                    Intent intent = new Intent(Mod_SearchPage.this, Mod_ViewProfile.class);
