...
public class Mod_AddPostPage extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mod_add_post_page);
    ...
    private void setupNavigation() {
        homeIcon.setOnClickListener(view -> startActivity(new Intent(Mod_AddPostPage.this, Mod_HomePage.class)));
        searchIcon.setOnClickListener(view -> startActivity(new Intent(Mod_AddPostPage.this, Mod_SearchPage.class)));
        addPostIcon.setOnClickListener(view -> startActivity(new Intent(Mod_AddPostPage.this, Mod_AddPostPage.class)));
        smallAvatar.setOnClickListener(view -> startActivity(new Intent(Mod_AddPostPage.this, Mod_ProfilePage.class)));
    }
        ...
        if (user != null) {
            reference.child(mAuth.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(Mod_AddPostPage.this, "Failed to load user data.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
