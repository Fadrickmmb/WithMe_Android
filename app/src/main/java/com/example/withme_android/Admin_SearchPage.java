...
public class Admin_SearchPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchInput = findViewById(R.id.admin_searchPage_input);
        searchButton = findViewById(R.id.admin_searchPage_searchButton);
        result01 = findViewById(R.id.admin_searchPage_result01);
        result02 = findViewById(R.id.admin_searchPage_result02);
        toHome = findViewById(R.id.admin_searchPage_buttonToHome);
                        ...
                        for (DataSnapshot userSnapshot : snapshot.getChildren()) {
                            ...
                            if (name != null && name.toLowerCase().startsWith(searchPrefix)) {
                                ...
                                result01.setOnClickListener(v -> {
                                    Intent intent = new Intent(Admin_SearchPage.this, Admin_ViewProfile.class);
