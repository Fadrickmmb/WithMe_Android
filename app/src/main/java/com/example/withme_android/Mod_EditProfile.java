...
public class Mod_EditProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mod_edit_profile);
        ...
        storageReference = FirebaseStorage.getInstance().getReference("mod_profile_pictures");
        firebaseUser = FirebaseAuth.getInstance().getCurrentUser();
        firebaseDatabase = FirebaseDatabase.getInstance().getReference("mod");
        ...
        homeIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Mod_EditProfile.this, User_HomePage.class);
        ...
        searchIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Mod_EditProfile.this, User_SearchPage.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        addPostIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Mod_EditProfile.this, User_AddPostPage.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        smallAvatar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Mod_EditProfile.this, User_ProfilePage.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnLogout.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Mod_EditProfile.this, Auth_Login.class);
    ...
    private void fetchUserData() {
        ...
        firebaseDatabase.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (user != null) {
                        ...
                        Glide.with(Mod_EditProfile.this)
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Mod_EditProfile.this, "Failed to retrieve user data", Toast.LENGTH_LONG).show();
            }
        });
    }
