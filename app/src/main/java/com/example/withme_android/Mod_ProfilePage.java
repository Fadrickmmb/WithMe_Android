...
public class Mod_ProfilePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editProfileBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Mod_ProfilePage.this, Mod_EditProfile.class);
        ...
        homeIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Mod_ProfilePage.this, Mod_HomePage.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        searchIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Mod_ProfilePage.this, Mod_SearchPage.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        addPostIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Mod_ProfilePage.this, Mod_AddPostPage.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        smallAvatar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Mod_ProfilePage.this, Mod_ProfilePage.class);
                startActivity(intent);
                finish();
            }
        });
            ...
            reference.child(mAuth.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (userProfile != null) {
                        ...
                        Log.d("ModProfile", "Posts Map: " + postsMap);
                        ...
                        followersLayout.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if(followersMap != null) {
                                    Intent intent = new Intent(Mod_ProfilePage.this, User_Followers.class);
                                    intent.putStringArrayListExtra("followersList", new ArrayList<>(userProfile.getFollowers().keySet()));
                                    startActivity(intent);
                                } else {
                                    Toast.makeText(Mod_ProfilePage.this, "You have no followers.", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                        ...
                        followingLayout.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if(followingMap != null) {
                                    Intent intent = new Intent(Mod_ProfilePage.this, User_Following.class);
                                    intent.putStringArrayListExtra("followingList", new ArrayList<>(userProfile.getFollowing().keySet()));
                                    startActivity(intent);
                                } else {
                                    Toast.makeText(Mod_ProfilePage.this, "You don't follow anyone.", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    } else {
                        Toast.makeText(Mod_ProfilePage.this, "User data not found.", Toast.LENGTH_SHORT).show();
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(Mod_ProfilePage.this, "Failed to load user data.", Toast.LENGTH_SHORT).show();
